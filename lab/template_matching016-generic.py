...
# Not looking for doors anymore as we left room detection on the side
...
if (os.path.isdir(f'{input_folder}')):
  ...
  print(f'{input_folder} must contain the following folders: floorplans, bathtubs, showers, sinks, toilets')
  exit(0)
