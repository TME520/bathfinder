...
image1 = cv2.imread("./TRY003-input/journal1.jpg")
image2 = cv2.imread("./TRY003-input/news1.jpg")
image3 = cv2.imread("./TRY003-input/CookingAtItsBest.png")
...
cv2.imwrite("./TRY003-output/letter/output1_letter.jpg", output1_letter)	
cv2.imwrite("./TRY003-output/word/output1_word.jpg", output1_word)
cv2.imwrite("./TRY003-output/line/output1_line.jpg", output1_line)
output1_par = process_par(th1,output1_par)
cv2.imwrite("./TRY003-output/par/output1_par.jpg", output1_par)
output1_margin = process_margin(th1,output1_par)
cv2.imwrite("./TRY003-output/margin/output1_margin.jpg", output1_par)
...
cv2.imwrite("./TRY003-output/letter/output2_letter.jpg", output2_letter)	
cv2.imwrite("./TRY003-output/word/output2_word.jpg", output2_word)
cv2.imwrite("./TRY003-output/line/output2_line.jpg", output2_line)
output2_par = process_par(th2,output2_par)
cv2.imwrite("./TRY003-output/par/output2_par.jpg", output2_par)
output2_margin = process_margin(th2,output2_par)
cv2.imwrite("./TRY003-output/margin/output2_margin.jpg", output2_par)
...
cv2.imwrite("./TRY003-output/letter/output3_letter.jpg", output3_letter)	
cv2.imwrite("./TRY003-output/word/output3_word.jpg", output3_word)
cv2.imwrite("./TRY003-output/line/output3_line.jpg", output3_line)
output3_par = process_par(th3,output3_par)
cv2.imwrite("./TRY003-output/par/output3_par.jpg", output3_par)
output3_margin = process_margin(th3,output3_par)
cv2.imwrite("./TRY003-output/margin/output3_margin.jpg", output3_par)
