...
# Output folder and log file cleanup
# No CSV and image when no items detected
# Generate report.txt file in output folder
# New: Generate assets inventory in output folder (csv)
